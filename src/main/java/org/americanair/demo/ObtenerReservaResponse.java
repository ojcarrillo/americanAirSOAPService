 ...
 *         &lt;element name="pasajeros" type="{http://www.americanair.org/demo/}persona" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="vuelo" type="{http://www.americanair.org/demo/}vuelo" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
